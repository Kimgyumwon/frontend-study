...
// HTML에서 해당 요소를 검색하여 찾은첫 번째 요소 하나만 반환
// 요소를 찾이 못하면 null을 반환
...
boxEl.addEventListener('click',function (e) {
  ...
  // (중요) this 와 event 객체
  console.log(this); // this: EventListener에서의 this는 이벤트가 바인딩된 요소를 가리킴 예:(<div>)
  ...
  // 제거하기
  boxEl.classList.remove('active'); // 요소에 active라는 클래스를 추가
